...
const BoardBtns = ({arrivalClick, departureClick, handleChangeDepartures, handleChangeArrivals}) => {
    ...
    return (
        <div className="btn-section">
            <button className={departureClass}
                onClick={handleChangeDepartures}
            >
                Departures
            </button>
            <button className={arrivalClass}
                onClick={handleChangeArrivals}
            >
                Arrivals
            </button>
        </div>
