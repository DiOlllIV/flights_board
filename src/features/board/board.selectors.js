...
export const boardListSelector = (state) => state.board.flightsList;

export const boardArrivalClick = (state) => state.board.arrivalClick;

export const boardDepartureClick = (state) => state.board.departureClick;

export const filterTextSelector = (state) => state.board.filterText;
